    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 
        ...
        <div className='felx flex-col md:items-start items-center w-full'>
          ...
          <p className='mt-10 text-center md:text-left text-sm text-white/60'>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
            Ut quibusdam inventore pariatur aspernatur praesentium?
        ...
        <div className='hidden md:flex flex-col items-start w-full'>
          ...
          <p className='text-sm text-white/80'>The latest news, articles, and resources,
           sent your inbox weekly.</p>
           <div className='flex items-center gap-2 pt-4'>
            <input type="email" placeholder='Enter your email'
              className='border border-gray-500/80 bg-gray-800 text-gray-500 placeholder-gray-500
