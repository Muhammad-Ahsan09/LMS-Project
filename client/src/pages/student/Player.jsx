...
const Player = () => {
  ...
  const {enrolledCourses, calulateChapterTime, fetchUserEnrolledCourses, backendUrl, getToken,
                    ...
                    <ul className='list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600'>
                      {
                        chapter.chapterContent.map((lecture, i) => (
                          ...
                          <li key={i} className='flex items-start gap-2 py-1'>
                            <img src={progressData && progressData.lectureCompleted && progressData.lectureCompleted.includes(playerData.lectureId)
                             ? assets.blue_tick_icon : assets.play_icon} alt="" />
              ...
              <Youtube videoId={playerData.lectureUrl.split("/").pop()} opts={{playerVars: {
                ...
                <div className='flex justify-between items-center mt-1'>
                  ...
                  <button onClick={() => { markLectureAsCompleted(playerData.lectureId)}}
                   className='text-blue-600'>{progressData && progressData.lectureCompleted && progressData.lectureCompleted.includes(playerData.lectureId) ? "Completed" : "Mark Complete"}</button>
                </div>
            </div>
            :
