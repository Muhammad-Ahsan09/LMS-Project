    ...
    md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
          ...
          <div className='flex'>
            {[...Array(5)].map((_, index) => (<img key={index}
              src={index < Math.floor(calculateAverageRating(courseData)) ? assets.star : assets.star_blank}
      ...
      overflow-hidden bg-white min-w-[300px] sm:min-w-[420]'>
        ...
        <div className='p-5'>
          ...
          <div className='flex gap-3 items-center pt-2'>
            ...
            <p className='md:text-lg text-gray-500 line-through'>{currency}{Math.floor(courseData.coursePrice)}</p>
          ...
          <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
            ...
            <div className='flex items-center gap-1'>
              ...
              <p>{caluclateCourseDuration(courseData)}</p>
            </div>
